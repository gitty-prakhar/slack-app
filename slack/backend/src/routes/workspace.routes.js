...
import { createWorkspace, getUserWorkspaces, getWorkspace, joinWorkspace, getWorkspaceMembers, deleteWorkspace } from "../controllers/workspace.controller.js";
...
router.route("/:workspaceId").get(verifyJWT,getWorkspace).delete(verifyJWT,deleteWorkspace);
